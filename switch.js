...
function switchLanguage() {
    ...
    const t = {
        it: {
            ...
            storia_text: "Ho studiato eventi storici moderni e contemporanei, principalmente guerre mondiali.",
            ing_text: "Miglioramento della comprensione e produzione scritta e orale.",
            mate_text: "Ho studiato algebra, funzioni, limiti, derivate, integrali, probabilità e statistica.",
        ...
        en: {
            ...
            tpsit_text: "I further developed the design of software passing to android, and using Java I created some simple applications.",
            ita_text: "I developed the ability to analyze and produce text, and studied authors and literary movements.",
            storia_text: "I studied modern and contemporary historical events, mainly the World Wars.",
            ing_text: "Improvement of comprehension and production of written and oral communication.",
